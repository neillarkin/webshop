...
def login(request):
    ...
    #returned to Login.html template with key and value(form instance of UserLoginForm class)

""" Validates Registration form and creates a new User """
...
""" Update user chnages from edit profile template form """
